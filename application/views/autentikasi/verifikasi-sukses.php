        ...
        <?php $this->load->view('template/autentikasi/_header') ?>
            ...
            <div class="col-lg-7 pt-5 mt-5">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header"><h3 class="text-center font-weight-light my-4 text-success">Verifikasi Sukses</h3></div>
                    <div class="card-body py-5">
                        <p class="m-0 text-center">Selamat ! Akun anda telah aktif. Sekarang anda telah bisa masuk ke situs ini.</p>
