...
<html lang="en">
    <head>
        ...
        <title><?= $this->config->item('nama_situs') ?> - Lupa Kata Sandi</title>
        ...
        <?php $this->load->view('template/autentikasi/_header') ?>
            ...
            <div class="col-lg-7 pt-5 mt-5">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header"><h3 class="text-center font-weight-light my-4 text-success">Pesan Berhasil Dikirim</h3></div>
                    <div class="card-body py-5">
                        <p class="m-0 text-center">Silahkan periksa email anda untuk melakukan setel ulang kata sandi.</p>
                        <p class="text-center">
                            <a href="<?= base_url('') ?>"
