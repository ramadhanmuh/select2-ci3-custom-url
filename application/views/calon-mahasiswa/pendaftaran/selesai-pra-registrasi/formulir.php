...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-3">
                            ...
                            <!-- Alur -->
                            <?php $this->load->view('calon-mahasiswa/pendaftaran/selesai-pra-registrasi/_alur') ?>
                            <!-- End Of Alur -->
                        ...
                        <div class="row position-relative">
                            <div class="col-12">
                                <!-- Form -->
                                <?php $this->load->view('calon-mahasiswa/pendaftaran/selesai-pra-registrasi/_cetak-praregistrasi') ?>
        ...
        <script src="<?= base_url('assets/scripts/pages/calon-mahasiswa/pendaftaran/selesai-pra-registrasi.js') ?>"
            defer></script>
